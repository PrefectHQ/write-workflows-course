...
def get_nationals_most_recent_game():
    ...
    # Fetch the baseball schedule from the MLB API
    ...
    print(most_recent_game.get("officialDate"))
    print(most_recent_game.get("teams").get("away").get("team").get("name"))
    print(most_recent_game.get("teams").get("home").get("team").get("name"))


if __name__ == "__main__":
    get_nationals_most_recent_game()
